...
DATABASE_URL = "postgresql://postgres.nhlnmqcrecaufaetytbi:REDACTED_ROTATED_PASSWORD@aws-1-sa-east-1.pooler.supabase.com:5432/postgres"
RESEND_API_KEY = "REDACTED_ROTATED_API_KEY"
